...
package com.jinxin.jxtouchscreen.widget.wheelview;
...
public class WheelView extends View {
	...
	private static final int[] SHADOWS_COLORS = new int[] { 0xf000053b,
			0xaa00053b, 0x0f00033d };
	...
	private void initResourcesIfNecessary() {
		...
		if (valuePaint == null) {
			...
			valuePaint.setShadowLayer(0.1f, 0, 0.4f, 0x0f414141);
		}
