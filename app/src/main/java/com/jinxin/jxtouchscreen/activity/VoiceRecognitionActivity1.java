...
/**
 * Created by HJK on 2017/4/13.
 */

public class VoiceRecognitionActivity1 extends BaseActivity implements View.OnClickListener{
    ...
    //记录连续没有说话的次数
    private int count = 0;
    private int identificationNumber ;//识别次数
    ...
    protected void initView() {
        ...
        setContentView(R.layout.content_voice_recognition1);
        ...
        public void onError(SpeechError error) {
            ...
            if (count == 10){
                ...
                if(identificationNumber==1){
                    mVoiceToastTextView.setText(context.getString(R.string.please_waiting));
