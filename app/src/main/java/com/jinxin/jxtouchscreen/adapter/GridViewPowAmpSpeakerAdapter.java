...
/**
 * Created by ZJ on 2016/12/7 0007.
 */
public class GridViewPowAmpSpeakerAdapter extends BaseAdapter {

    LayoutInflater layoutInflater;
    private String[] items;
    private boolean[] status;

    public GridViewPowAmpSpeakerAdapter(Context context, String[] items, boolean[] staus) {
